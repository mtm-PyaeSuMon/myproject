              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  <div class="form-outline">
                    ...
                    <form:input path="name" value="${user.name}" type="text" id="name" class="form-control form-control-lg" placeholder="Name" />
                ...
                <div class="col-md-6 mb-4">
                  <div class="form-outline">
					...
					<form:input path="email"  value="${user.email}" type="email" id="email" class="form-control form-control-lg" placeholder="Your Email(example@gmail.com)" />
                ...
                <div class="col-md-6">
					...
					<c:if test="${fn:contains(userForm.photo,'base64') }">
						<c:set var="jspViewPhoto" value="${userForm.photo}" />
							...
							<img src="<%=request.getContextPath()%>/resources/img/images.jpg" id="image" class="user-photo" />
						</c:if>
					</div>
					</div>
					<div class="row">
                ...
                <div class="col-md-6 mb-4">
                  <div class="form-outline">
                   <form:label path="bio" for="bio" class="form-label">Bio</form:label><br>
                    <form:textarea path="bio" value="${user.bio}"  class="form-control textarea" rows="3" placeholder="Your Bio"></form:textarea>
